...
import { AIGenerateTextButton } from "@/components/ai-generate-text-button";
import { ImageUploadTriggerButton } from "@/components/image-upload-trigger-button";
import { InngestTriggerButton } from "@/components/inngest-trigger-button";

export default function Home() {
	return (
		<div className="isolate flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
			<main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between bg-white px-16 py-32 sm:items-start dark:bg-black">
				...
				<div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
					...
					<div className="flex flex-wrap items-center gap-3">
						<InngestTriggerButton />
						<ImageUploadTriggerButton />
					</div>
